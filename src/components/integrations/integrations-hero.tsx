            ...
            <Wrapper className="py-20">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full">
                    <div className="flex flex-col w-full z-10">
                        ...
                        <Container delay={0.1}>
                            <h2 className="text-balance !leading-[1.25] text-4xl md:text-6xl font-semibold tracking-tight mt-6 w-full text-foreground">
                                Integrate with <br className="hidden lg:inline-block" /> Any Technology
                            </h2>
                        </Container>

                        <Container delay={0.2}>
                            <p className="text-base md:text-lg font-normal text-balance text-muted-foreground max-w-3xl mt-4">
                                Our voice agent template supports custom integrations with any technology stack. Connect with AI providers, databases, APIs, and third-party services to build your perfect voice solution.
                            </p>
                        </Container>
                            ...
                            <div className="flex flex-col gap-2 mt-6">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm text-muted-foreground font-medium">
                                        OpenAI, Anthropic, and custom AI providers
                                    </span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <CheckCircle2Icon className="size-4 text-primary" />
                                    <span className="text-sm text-muted-foreground font-medium">
                                        PostgreSQL, MongoDB, and any database
                                    </span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <CheckCircle2Icon className="size-4 text-primary" />
                                    <span className="text-sm text-muted-foreground font-medium">
                                        REST APIs, GraphQL, and webhook integrations
                                    </span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <CheckCircle2Icon className="size-4 text-primary" />
                                    <span className="text-sm text-muted-foreground font-medium">
                                        Stripe, Polar, and payment processors
                                    </span>
                                </div>
                            </div>
                        </Container>
