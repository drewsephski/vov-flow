            ...
            <Wrapper>
                <Container>
                    <div className="flex flex-col items-start justify-start lg:items-center lg:justify-center">
                        <h2 className="text-3xl lg:text-4xl font-semibold text-left lg:text-center tracking-tight text-foreground">
                            Enterprise-Grade Voice AI for SaaS Startups
                        </h2>
                        <p className="text-base lg:text-lg font-normal text-muted-foreground text-left lg:text-center max-w-md mt-2">
                            Power your startup with cutting-edge voice agent technology that scales with your growth
                        </p>
                    </div>
                </Container>
