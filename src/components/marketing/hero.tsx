...
import { Shatter } from "../ui/shatter-button";

const Hero = () => {
    return (
        <div className="relative z-0 w-full h-full">

            <div className="absolute -top-16 inset-x-0 -z-10 mx-auto w-3/4 h-32 lg:h-40 rounded-full blur-[5rem] bg-[radial-gradient(86.02%_172.05%_at_50%_-40%,rgba(18,139,135,1)_0%,rgba(5,5,5,0)_80%)]" />
                ...
                <div className="flex flex-col items-center justify-center w-full z-10">
                    ...
                    <Container delay={0.1}>
                        <h2 className="text-balance !leading-[1.25] text-center text-5xl md:text-6xl font-semibold tracking-tight mt-6 w-full">
                            Build & Deploy Voice Agents <br className="hidden lg:inline-block" /> in Minutes
                        </h2>
                    </Container>

                    <Container delay={0.2}>
                        <p className="text-base md:text-lg font-normal text-center text-balance text-muted-foreground max-w-3xl mx-auto mt-4">
                            Launch AI-powered voice agents for your SaaS startup with enterprise-grade voice recognition, natural language processing, and seamless integration—get to market 10x faster
                        </p>
                    </Container>
