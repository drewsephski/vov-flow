...
export function Shatter({
  ...
  }, [isShattered, shardCount, onClick, router])

  return (
    <div className="relative inline-block">
      <motion.div
        className={`relative px-8 py-4 font-semibold rounded-xl overflow-hidden cursor-pointer ${className}`}
        onClick={handleClick}
        animate={{
        ...
        whileTap={{ scale: 0.95 }}
        whileHover={{
          boxShadow: `0 0 20px ${shatterColor}33, inset 0 0 25px ${shatterColor}44`,
        }}
        style={{
          background: `linear-gradient(135deg, ${shatterColor}22 0%, ${shatterColor}44 100%)`,
          border: `1px solid ${shatterColor}66`,
          color: shatterColor,
          boxShadow: `0 0 20px ${shatterColor}33, inset 0 0 15px ${shatterColor}22`,
        }}
      >
