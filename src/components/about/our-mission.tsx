                    ...
                    <div className="flex flex-col px-2 md:px-0 h-full">
                        ...
                        <Container delay={0.1}>
                            <h2 className="text-3xl md:text-4xl font-semibold text-left tracking-tight mt-4">
                                Empowering developers to build voice agents
                            </h2>
                        </Container>
                        <Container delay={0.3}>
                            <p className="text-base md:text-lg text-muted-foreground text-left mt-2 max-w-2xl">
                                Every developer should build voice agents without vendor lock-in. Our template provides the foundation for innovation.
                            </p>
                            <p className="text-base lg:text-lg font-normal text-muted-foreground mt-4">
                                Committed to open source, developer freedom, and tools that solve real problems.
                            </p>
                        </Container>
                    </div>
