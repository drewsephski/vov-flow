                    ...
                    <div className="flex flex-col w-full z-10">
                        ...
                        <Container delay={0.1}>
                            <h2 className="text-balance !leading-[1.25] text-4xl md:text-6xl font-semibold tracking-tight text-center lg:text-left mt-6 w-full">
                                The Complete <br className="hidden lg:inline-block" /> Voice Agent Solution
                            </h2>
                        </Container>

                        <Container delay={0.2}>
                            <p className="text-base lg:text-lg text-muted-foreground text-center lg:text-left mt-4 max-w-2xl mx-auto lg:mx-0">
                                Launch voice agents fast with our complete template. <br />Built for developers who value freedom and flexibility.
                            </p>
                        </Container>
